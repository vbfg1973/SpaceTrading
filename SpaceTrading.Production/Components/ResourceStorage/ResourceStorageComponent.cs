...
{
    public ResourceStorageComponent(float volume)
    {
    ...
    public float VolumeTaken => Storage.Values.Sum(x => x.Volume);

    public float VolumeRemaining => Volume - VolumeTaken;
    ...
    public bool WillFit(float volume)
    {
